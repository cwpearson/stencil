...
TEST_CASE("partition") {
  ...
  SECTION("10x3x1 into 4x1") {
    ...
    REQUIRE(Dim3(0, 0, 0) == part.subdomain_origin(Dim3(0, 0, 0)));
    REQUIRE(Dim3(3, 0, 0) == part.subdomain_origin(Dim3(1, 0, 0)));
    REQUIRE(Dim3(6, 0, 0) == part.subdomain_origin(Dim3(2, 0, 0)));
    REQUIRE(Dim3(8, 0, 0) == part.subdomain_origin(Dim3(3, 0, 0)));
  }
  ...
  SECTION("10x14x2 into 3x3x1") {
    ...
    REQUIRE(Dim3(0, 0, 0) == part.subdomain_origin(Dim3(0, 0, 0)));
    REQUIRE(Dim3(4, 5, 0) == part.subdomain_origin(Dim3(1, 1, 0)));
    REQUIRE(Dim3(7, 10, 0) == part.subdomain_origin(Dim3(2, 2, 0)));
  }
}